...
structures = (('2vqp', 'FIRST:A', '126:A', 'A'), ('2ykd', 'FIRST:A', '130:A', 'A'),     #RSV
              ('4lp7', 'FIRST:B', '127:B', 'B'),                              #Metapneumovirus
              ('1h2d', 'FIRST:A', 'LAST:A', 'A'), ('1h2c', 'FIRST:A', 'LAST:A', 'A'), ('4ldm', 'FIRST:A', 'LAST:A', 'A'), #Ebola (1 domain)
              ('4ldd', 'FIRST:B', '190:B', 'B'), ('1es6', 'FIRST:A', '190:A', 'A'), ('4ldi', 'FIRST:A', '190:A', 'A'), #Ebola
              ('4ld8', 'FIRST:A', '190:A', 'A'), ('3tcq', 'FIRST:A', '190:A', 'A'), ('4ldb', 'FIRST:C', '190:C', 'C'), #Ebola
              ('4g1l', 'FIRST:B', '188:B', 'B'), ('4g1g', 'FIRST:B', '188:B', 'B'), ('4g1o', 'FIRST:B', '188:B', 'B')) #Newcastle
